...
describe('total likes',() => {
  ...
  test('0 blog',() => {
    expect(listHelper.totlaLikes(listWithZeroBlog)).toBe(0)
  })
  test('1 blog',() => {
    expect(listHelper.totlaLikes(listWithOneBlog)).toBe(5)
  })
  test('more blogs',() => {
    expect(listHelper.totlaLikes(listWithMultipleBlog)).toBe(23)
  })
